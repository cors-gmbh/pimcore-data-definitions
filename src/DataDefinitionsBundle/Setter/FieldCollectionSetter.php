...
final class FieldCollectionSetter implements SetterInterface, GetterInterface
{
    #[\Override]
    ...
    private function isValidKey(array $keys, AbstractFieldCollection $fieldcollection, array $data): bool
    {
        foreach ($keys as $key) {
